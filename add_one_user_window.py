...
def add_one_user(main_user):
    ...
    type_var = tk.IntVar()
    type_var.set(0)
    r_s = tk.Radiobutton(text="Студент", variable=type_var, value=0, command=change)
    r_t = tk.Radiobutton(text="Преподаватель", variable=type_var, value=1, command=change)
